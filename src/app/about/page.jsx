    ...
    >
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center pb-48" ref={experinceRef}>
            <motion.h1 initial={{x:"-300px"}} animate={isExperinceRefInView ? {x:0} : {}} transition={{delay:0.2}} className="font-bold text-2xl">EXPERIENCES</motion.h1>
            <motion.div initial={{x:"-300px"}} animate={isExperinceRefInView ? {x:0} : {}} className="">
